...
def run_alpha_sweep():
    ...
    for alpha in ALPHA_VALUES:
        ...
        bert_scores = bertscore.compute(
            ...
            device=DEVICE,
            batch_size=BERT_BATCH_SIZE # Process in larger batches
        )
        
        # Move Pegasus back to GPU for next alpha if it was offloaded
        if torch.cuda.is_available() and gpu_memory_gb < 20 and alpha != ALPHA_VALUES[-1]:
